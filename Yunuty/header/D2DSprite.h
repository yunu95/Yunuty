...
namespace YunutyEngine
{
    namespace D2D
    {
        ...
        private:
            ...
            Rect drawRect = Rect(100,100);
        public:
            void SetSpriteFilePath(const wstring& spriteFilePath) { this->spriteFilePath = spriteFilePath; }
            wstring GetRpriteFilePath() { return spriteFilePath; }
